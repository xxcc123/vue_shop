    ...
    <div>
      ...
      <el-card class="box-card">
        ...
        <el-table :data="orderlist" border stripe>
          ...
          <el-table-column label="订单总额" prop="total_amount"></el-table-column>
          <el-table-column label="打印状态" prop="print_status"></el-table-column>
          ...
          <el-table-column label="收件人" prop="order_address.name"></el-table-column>
          <el-table-column label="商品名" prop="order_detail.0.goods_name"></el-table-column>
...
export default {
  ...
  methods: {
    async getOrderList() {
      const { data: res } = await this.$http.get('api/order', { params: this.queryInfo })
      // console.log(res)
